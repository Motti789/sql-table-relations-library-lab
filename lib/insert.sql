INSERT INTO series (id, title, author_id, subgenre_id) VALUES (1, 'The Great Show', 1, 1), (2, 'The Greatest Author', 2, 2); 

INSERT INTO books (id, title, year, series_id) VALUES (1, 'Chochma', 1997, 1), (2, 'Bina', 1998, 1), (3, 'Daas', 1999, 1), (4, 'Chesed', 2000, 2), (5, 'Gevurah', 2001, 2), (6, 'Tiferes', 2002, 3);
